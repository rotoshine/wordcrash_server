 ...
 * GET     /api/quizs/:id          ->  show
 * PUT     /api/quizs/:id          ->  update
 * DELETE  /api/quizs/:id          ->  destroy
 */
...
export function index(req, res) {
  return Quiz.find().populate('questions', '_id questionText currectAnswer').exec()
...
export function show(req, res) {
  return Quiz.findById(req.params.id).populate('questions', '_id questionText').exec()
